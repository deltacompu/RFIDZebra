...
public class ScanTags {
                        ...
                        if(alertOf.contains(scannerTypeCode) && !deafen.contains(scannerCode)){
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    //Write into the file
                                    FileWriter fWriter = new FileWriter("/mnt/data/app/ErrorLog.txt", true);
    ...
    public static void callUrl(String assetCode) throws MalformedURLException{
        try{
            URL url = new URL("http://dev-dsk-davsuar-2b-a59798a1.us-west-2.amazon.com:3000/api/newread?scannerCode="+assetCode);
